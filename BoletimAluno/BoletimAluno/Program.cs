...
namespace RelatorioAlunos
{
    class Program
    {
        static void Main()
        {
            ...
            List<AlunoEnsinoSuperior> alunoSuperior = new();
            var opcaoMenu = ObtenhaOpcaoSelecionada().ToUpper();
            string opcaoDeEnsino = "";
            int validacaoNumero;
            ...
            while(opcaoMenu != "X") {
                switch (opcaoMenu)
                {
                    case "1":
                        ...
                        {
                            switch (opcaoDeEnsino)
                            {
                                case "1":
                                    Console.WriteLine("Ensino basico");                                   
                                    break;
                                case "2":
                                    Console.WriteLine("Ensino Superior");
                                    
                                    break;
                                default:
                                    Console.WriteLine("Insira uma opcao valida");
                                    Console.WriteLine("[1] - Aluno Ensino Básico\n[2] - Aluno Ensino Médio");
                                    opcaoDeEnsino = Console.ReadLine() ?? "";
                                    break;
                            }
                        }
